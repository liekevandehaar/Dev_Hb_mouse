...
# GLASTEGFmixSEZ
#import files
L1 <- read.csv("./data/cout/Habenula_E18_L1_velo_cbc_trimmed_star_total.coutt.tsv",sep="\t",header=TRUE)
L2 <- read.csv("./data/cout/Habenula_E18_L2_velo_cbc_trimmed_star_total.coutt.tsv",sep="\t",header=TRUE)
R1 <- read.csv("./data/cout/Habenula_E18_R1_velo_cbc_trimmed_star_total.coutt.tsv",sep="\t",header=TRUE)
R2 <- read.csv("./data/cout/Habenula_E18_R2_velo_cbc_trimmed_star_total.coutt.tsv",sep="\t",header=TRUE)
LR <- read.csv("./data/cout/Habenula_E18_Pl5_velo_cbc_trimmed_star_total.coutt.tsv",sep="\t",header=TRUE)
...
#save
library(rio)
export(Series_Jun2019_merge, "merged_E18_Habenula.coutt_total_2.tsv", row.names = T)
