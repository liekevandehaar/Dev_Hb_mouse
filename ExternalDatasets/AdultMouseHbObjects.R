...
save(wallace_hb, file="data/output/ExternalDatasets/Wallace_Seurat_obj.RData")

#save average expression per cluster for MAGMA analysis
wallace_avg <- AverageExpression(wallace_hb, assays = "RNA")[[1]]
write.table(wallace_avg, file="data/output/MAGMA/Jun2020_GWAS_wallace.csv")
...
write.table(stuber_avg, file="data/output/MAGMA/Jun2020_GWAS_stuber.csv")
