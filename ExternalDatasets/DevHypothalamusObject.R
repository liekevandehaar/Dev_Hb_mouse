...
meta <- read.csv("data/input/GSE132355_E10-P45_umap_data.csv", header=T, row.names=1)
data <- readRDS("data/input/GSE132355_E10-P45_log2cpm.rds")
...
#save full object
save(hypo, file="data/output/ExternalDatasets/DevHypothalamus_obj.RData")
...
save(subhypo, file="data/output/ExternalDatasets/DevHypothalamus-samp_obj.RData")