...
#Developmental Hb
eMDD <- read.table("data/output/GWAS/MDD2-18/Jul2020_GWAS_MDD_embryo_AVG.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
...
eBMI <- read.table("data/output/GWAS/BMI/Jun2020_GWAS_BMI_embryo_AVG.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
...
#eBMI$VARIABLE <- c("early Hb2[1]", "PC2[12]", "early Hb1[0]", "early dMHb[4]", "iHb2[8]", "PC1[13]", "iHb1[6]",
 #                  "LHb[11]", "vMHb2[3]", "vMHb1[2]", "dMHb2[5]", "dMHb3[7]", "dMHb1[10]", "vMHb3[9]")
eSCZ <- read.table("data/output/GWAS/SCZ/Jul2020_GWAS_SCZ_embryo_AVG.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
...
#eSCZ$VARIABLE <- c("early Hb2[1]", "PC2[12]", "early Hb1[0]", "early dMHb[4]", "iHb2[8]", "PC1[13]", "iHb1[6]",
 #                  "LHb[11]", "vMHb2[3]", "vMHb1[2]", "dMHb2[5]", "dMHb3[7]", "dMHb1[10]", "vMHb3[9]")
eBIP <- read.table("data/output/GWAS/BIP/Jun2020_GWAS_BIP_embryo_AVG.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
...
#eBIP$VARIABLE <- c("early Hb2[1]", "PC2[12]", "early Hb1[0]", "early dMHb[4]", "iHb2[8]", "PC1[13]", "iHb1[6]",
 #                  "LHb[11]", "vMHb2[3]", "vMHb1[2]", "dMHb2[5]", "dMHb3[7]", "dMHb1[10]", "vMHb3[9]")
eHeight <- read.table("data/output/GWAS/Height/Jun2020_GWAS_Height_embryo_AVG.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
...
sMDD <- read.table("data/output/GWAS/MDD2-18/Jul2020_GWAS_MDD_stuber_AVG.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
...
sBMI <- read.table("data/output/GWAS/BMI/Jun2020_GWAS_BMI_stuber_AVG.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
sBMI$GWAS <- c("BMI 2015", "BMI 2015","BMI 2015","BMI 2015","BMI 2015","BMI 2015","BMI 2015","BMI 2015",
                     "BMI 2015","BMI 2015","BMI 2015","BMI 2015")
sSCZ <- read.table("data/output/GWAS/SCZ/Jul2020_GWAS_SCZ_stuber_AVG.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
sSCZ$GWAS <- c("SCZ 2018", "SCZ 2018","SCZ 2018","SCZ 2018","SCZ 2018","SCZ 2018","SCZ 2018","SCZ 2018",
               "SCZ 2018","SCZ 2018","SCZ 2018","SCZ 2018")
sBIP <- read.table("data/output/GWAS/BIP/Jun2020_GWAS_BIP_stuber_AVG.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
sBIP$GWAS <- c("BIP 2016", "BIP 2016","BIP 2016","BIP 2016","BIP 2016","BIP 2016","BIP 2016","BIP 2016",
               "BIP 2016","BIP 2016","BIP 2016","BIP 2016")
sHeight <- read.table("data/output/GWAS/Height/Jun2020_GWAS_Height_stuber_AVG.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
...
#Wallace, et al (2020)
wMDD <- read.table("data/output/GWAS/MDD2-18/Jul2020_GWAS_MDD_wallace_AVG.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
...
wBMI <- read.table("data/output/GWAS/BMI/Jun2020_GWAS_BMI_wallace_AVG.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
...
wBMI$VARIABLE <- c("Ventral2/3(MHb1)", "Ventrolateral(MHb2)", "Lateral(MHb3)", "Dorsal(MHb4)", "Superior(MHb5)", 
                   "Oval/Medial(LHb1)", "Marginal(LHb2)", "Lateral(LHb3)", "HBX(LHb4)")
wSCZ <- read.table("data/output/GWAS/SCZ/Jul2020_GWAS_SCZ_wallace_AVG.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
...
wSCZ$VARIABLE <- c("Ventral2/3(MHb1)", "Ventrolateral(MHb2)", "Lateral(MHb3)", "Dorsal(MHb4)", "Superior(MHb5)", 
                   "Oval/Medial(LHb1)", "Marginal(LHb2)", "Lateral(LHb3)", "HBX(LHb4)")
wBIP <- read.table("data/output/GWAS/BIP/Jun2020_GWAS_BIP_wallace_AVG.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
...
wBIP$VARIABLE <- c("Ventral2/3(MHb1)", "Ventrolateral(MHb2)", "Lateral(MHb3)", "Dorsal(MHb4)", "Superior(MHb5)", 
                   "Oval/Medial(LHb1)", "Marginal(LHb2)", "Lateral(LHb3)", "HBX(LHb4)")
wHeight <- read.table("data/output/GWAS/Height/Jun2020_GWAS_Height_wallace_AVG.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
...
tmMDD <- read.table("data/output/GWAS/MDD2-18/TabulaMuris_MDD_AVG.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
tmMDD$GWAS <- c("MDD2 2018", "MDD2 2018","MDD2 2018","MDD2 2018","MDD2 2018","MDD2 2018","MDD2 2018","MDD2 2018",
               "MDD2 2018")
tmBMI <- read.table("data/output/GWAS/BMI/TabulaMuris_BMI_AVG.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
tmBMI$GWAS <- c("BMI 2015", "BMI 2015","BMI 2015","BMI 2015","BMI 2015","BMI 2015","BMI 2015","BMI 2015",
               "BMI 2015")
tmSCZ <- read.table("data/output/GWAS/SCZ/TabulaMuris_SCZ_AVG.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
tmSCZ$GWAS <- c("SCZ 2018", "SCZ 2018","SCZ 2018","SCZ 2018","SCZ 2018","SCZ 2018","SCZ 2018","SCZ 2018",
               "SCZ 2018")
tmBIP <- read.table("data/output/GWAS/BIP/TabulaMuris_BIP_AVG.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
tmBIP$GWAS <- c("BIP 2016", "BIP 2016","BIP 2016","BIP 2016","BIP 2016","BIP 2016","BIP 2016","BIP 2016",
               "BIP 2016")
tmHeight <- read.table("data/output/GWAS/Height/TabulaMuris_Height_AVG.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
...
ggplot(gsa_all, aes(fill=Dataset, y=logP, x=VARIABLE)) + 
  ...
  ggsave("figures/GWAS/GWAS_methodKyoko-num.pdf", height=8, width=12)


#Merged mouse Hb dataset

#read in results and rbind() into melted format
mMDD <- read.table("data/output/GWAS/MDD2-18/Oct2020_GWAS_MDD2-18_merged_ANOVA.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
...
mBMI <- read.table("data/output/GWAS/BMI/Oct2020_GWAS_BMI_merged_ANOVA.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
...
mBMI$VARIABLE <- c('dorsal/lateral MHb(0)', 'ventro/lateral MHb1(1)','vMHb1(2)', 'dMHb(3)', 'vMHb2(4)', 'early Hb1(5)','LHb subtype1(6)', 
                   'LHb subtype3(7)', 'early Hb2(8)', 'ventro/lateral MHb2(9)', 'lateral MHb(10)', 'superior MHb(11)', 'LHb subtype2(12)', 'HBX(13)',
                   'iHb1 (to MHb)(14)', 'iHb2 (to LHb)(15)', 'PC(16)')
mSCZ <- read.table("data/output/GWAS/SCZ/Oct2020_GWAS_SCZ_merged_ANOVA.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
...
mSCZ$VARIABLE <- c('dorsal/lateral MHb(0)', 'ventro/lateral MHb1(1)','vMHb1(2)', 'dMHb(3)', 'vMHb2(4)', 'early Hb1(5)','LHb subtype1(6)', 
                   'LHb subtype3(7)', 'early Hb2(8)', 'ventro/lateral MHb2(9)', 'lateral MHb(10)', 'superior MHb(11)', 'LHb subtype2(12)', 'HBX(13)',
                   'iHb1 (to MHb)(14)', 'iHb2 (to LHb)(15)', 'PC(16)')
mBIP <- read.table("data/output/GWAS/BIP/Oct2020_GWAS_BIP_merged_ANOVA.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
...
mBIP$VARIABLE <- c('dorsal/lateral MHb(0)', 'ventro/lateral MHb1(1)','vMHb1(2)', 'dMHb(3)', 'vMHb2(4)', 'early Hb1(5)','LHb subtype1(6)', 
                   'LHb subtype3(7)', 'early Hb2(8)', 'ventro/lateral MHb2(9)', 'lateral MHb(10)', 'superior MHb(11)', 'LHb subtype2(12)', 'HBX(13)',
                   'iHb1 (to MHb)(14)', 'iHb2 (to LHb)(15)', 'PC(16)')
mHeight <- read.table("data/output/GWAS/Height/Oct2020_GWAS_Height_merged_ANOVA.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
...
ggplot(gsa_merge, aes(y=logP, x=VARIABLE)) + 
  ...
  xlab("") + ylab("-log10(P)") + theme(axis.text.x = element_text(angle=90, hjust=0.95,vjust=0.2, color="black", size=12),
                                       ...
                                       strip.text = element_text(face="bold", size=14),
                                       legend.text = element_text(size=12, color="black"),
                                       legend.title = element_text(size=13, color="black")) + ggsave("figures/GWAS/GWAS_merged-annotated_ANOVA.pdf")

#Developmental Hypothalamus dataset

#read in results and rbind() into melted format
hMDD <- read.table("data/output/GWAS/MDD2-18/Nov2020_GWAS_MDD2-18_DevHypo_ANOVA.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
hMDD$GWAS <- rep("MDD2 2018", 14)
hBMI <- read.table("data/output/GWAS/BMI/Nov2020_GWAS_BMI_DevHypo_ANOVA.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
hBMI$GWAS <- rep("BMI 2015", 14)
hSCZ <- read.table("data/output/GWAS/SCZ/Nov2020_GWAS_SCZ_DevHypo_ANOVA.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
hSCZ$GWAS <- rep("SCZ 2018", 14)
hBIP <- read.table("data/output/GWAS/BIP/Nov2020_GWAS_BIP_DevHypo_ANOVA.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
hBIP$GWAS <- rep("BIP 2016", 14)
hHeight <- read.table("data/output/GWAS/Height/Nov2020_GWAS_Height_DevHypo_ANOVA.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
...
ggplot(gsa_hypo, aes(y=logP, x=VARIABLE)) + 
  ...
  xlab("") + ylab("-log10(P)") + theme(axis.text.x = element_text(angle=90, hjust=0.95,vjust=0.2, color="black", size=12),
                                       ...
                                       strip.text = element_text(face="bold", size=14),
                                       legend.text = element_text(size=12, color="black"),
                                       legend.title = element_text(size=13, color="black")) + ggsave("figures/GWAS/GWAS_DevHypo_ANOVA.pdf")

#La Manno 2016 dataset

#read in results and rbind() into melted format
hMDD <- read.table("data/output/GWAS/MDD2-18/Nov2020_GWAS_MDD2-18_LaManno2016_ANOVA.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
hMDD$GWAS <- rep("MDD2 2018", 31)
hBMI <- read.table("data/output/GWAS/BMI/Nov2020_GWAS_BMI_LaManno2016_ANOVA.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
hBMI$GWAS <- rep("BMI 2015", 31)
hSCZ <- read.table("data/output/GWAS/SCZ/Nov2020_GWAS_SCZ_LaManno2016_ANOVA.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
hSCZ$GWAS <- rep("SCZ 2018", 31)
hBIP <- read.table("data/output/GWAS/BIP/Nov2020_GWAS_BIP_LaManno2016_ANOVA.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
hBIP$GWAS <- rep("BIP 2016", 31)
hHeight <- read.table("data/output/GWAS/Height/Nov2020_GWAS_Height_LaManno2016_ANOVA.gsa.out", header=TRUE, quote="\"")[,c(1,7)]
...
ggplot(gsa_hypo, aes(y=logP, x=VARIABLE)) + 
  ...
  xlab("") + ylab("-log10(P)") + theme(axis.text.x = element_text(angle=90, hjust=0.95,vjust=0.2, color="black", size=12),
                                       ...
                                       strip.text = element_text(face="bold", size=14),
                                       legend.text = element_text(size=12, color="black"),
                                       legend.title = element_text(size=13, color="black")) + ggsave("figures/GWAS/GWAS_LaMann016_ANOVA.pdf")
...
ggplot(signal, aes(y=weak, x=cluster)) + geom_bar(stat="identity", position="dodge") + geom_hline(yintercept=8, linetype="dashed") +
  ...
  ggsave("figures/GWAS/MAGMAsignal_weak.pdf")
...
ggplot(signal, aes(y=strong, x=cluster)) + geom_bar(stat="identity", position="dodge") + geom_hline(yintercept=8, linetype="dashed") +
  theme(axis.text.x = element_text(color="black", size=12),
        ...
        panel.background = element_blank(), axis.line = element_line(colour = "black"),
        strip.text = element_text(face="bold", size=14)) + xlab("") + ylab("") + scale_y_continuous(limits=c(0,10),breaks=c(0,2,4,6,8,10)) +
  ggsave("figures/GWAS/MAGMAsignal_strong.pdf")
